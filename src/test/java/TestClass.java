...
public class TestClass {
    ...
    public void delete_and_addNode(){
        ...
        Assert.assertEquals("Vertex is not exist! "+null,tree1.getNode(1,1));
       // Assert.assertEquals("Vertex is not exist! ",tree1.deleteNode(1,1));
        Assert.assertEquals("Vertex is not exist! "+null,tree1.getNode(2,1));
        Assert.assertEquals("Vertex is not exist! "+null,tree1.getNode(2,2));
        Assert.assertEquals("Vertex is not exist! "+null,tree1.getNode(3,1));
        Assert.assertEquals("Vertex is not exist! "+null,tree1.getNode(3,2));
